...
import { User, Mail, Lock, RotateCw, Sun, Moon, Home, Briefcase, Eye, EyeOff } from 'lucide-react';
            ...
            <div className="mt-3">
              ...
              <div className="mt-2.5 sm:mt-3 md:mt-4">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-4 py-2.5 sm:py-3 bg-white dark:bg-white border border-gray-300 dark:border-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-50 transition-colors shadow-sm hover:shadow-md"
                >
                  {/* Google Logo SVG */}
                  ...
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-700">Sign up with Google</span>
                </button>
              </div>
            </div>
