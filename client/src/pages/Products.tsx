...
// Mock Products Data - REMOVED: Now fetching from database

// Mock Collections Data - REMOVED: Now fetching from database
...
export function Products() {
  ...
  const loadCollections = async () => {
    try {
      ...
      // Note: You may need to create a collections endpoint
      // For now, set empty array - collections can be added later
      setCollections([]);
    } catch (error) {
