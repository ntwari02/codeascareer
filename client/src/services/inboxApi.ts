/**
 * Inbox API Service
 * Handles all inbox-related API calls
 */
...
export const inboxAPI = {
  ...
  async uploadFiles(
    ...
    return new Promise((resolve, reject) => {
      ...
      xhr.open('POST', `${API_BASE_URL}/seller/inbox/upload`);
  ...
  async getBuyers() {
    ...
    return handleResponse<{ buyers: any[] }>(response);
  },
  ...
  async seedTestThreads() {
    ...
    return handleResponse<{ message: string; threadsCreated: number }>(response);
  },
};
